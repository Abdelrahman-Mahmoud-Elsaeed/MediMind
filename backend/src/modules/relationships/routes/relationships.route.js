...
router.patch('/:relationshipId/status', authenticate, authorize('FAMILY_CAREGIVER', 'PROFESSIONAL_CAREGIVER', 'CAREGIVER'), validate(updateStatusSchema), relationshipsController.updateStatus);
