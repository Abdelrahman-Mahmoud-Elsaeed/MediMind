      ...
      <main className="pt-20">
        ...
        <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-gradient-to-br from-[#f8f9ff] to-[#e5eeff] dark:from-slate-950 dark:to-slate-900">
          ...
          <div className="relative z-20 px-6 sm:px-12 md:px-16 max-w-[1440px] mx-auto w-full grid grid-cols-1 lg:grid-cols-2 gap-12 items-center py-16">
            <div className="space-y-6">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-teal-600/10 border border-teal-600/20 text-teal-700 dark:text-teal-400 font-bold text-xs uppercase tracking-wider">
              ...
              <div className="flex flex-wrap gap-4 pt-4">
                <Link
                  href={heroBtnHref}
                  className="bg-teal-600 hover:bg-teal-700 text-white px-8 py-4 rounded-full font-bold active:scale-95 transition-all flex items-center gap-2 shadow-lg shadow-teal-600/20 dark:shadow-teal-900/40 animate-pulse"
                >
            ...
            <div className="relative flex justify-center items-center">
              <div className="w-full max-w-md bg-white/70 dark:bg-slate-900/70 backdrop-blur-md rounded-[40px] p-8 border border-white dark:border-slate-800 shadow-2xl relative overflow-hidden">
        ...
        <section id="features" className="py-24 px-6 sm:px-12 md:px-16 bg-white dark:bg-slate-900 scroll-mt-20">
          ...
          <div className="max-w-[1440px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-800 hover:bg-teal-50/50 dark:hover:bg-teal-950/20 transition-colors border border-slate-100 dark:border-slate-700 hover:border-teal-200 dark:hover:border-teal-900 group text-center">
              ...
              <h3 className="font-bold text-xl mb-3 text-[#0b1c30] dark:text-slate-100">{t('landing.features.f1Title')}</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.features.f1Desc')}</p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-800 hover:bg-teal-50/50 dark:hover:bg-teal-950/20 transition-colors border border-slate-100 dark:border-slate-700 hover:border-teal-200 dark:hover:border-teal-900 group text-center">
              ...
              <h3 className="font-bold text-xl mb-3 text-[#0b1c30] dark:text-slate-100">{t('landing.features.f2Title')}</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.features.f2Desc')}</p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-800 hover:bg-teal-50/50 dark:hover:bg-teal-950/20 transition-colors border border-slate-100 dark:border-slate-700 hover:border-teal-200 dark:hover:border-teal-900 group text-center">
              ...
              <h3 className="font-bold text-xl mb-3 text-[#0b1c30] dark:text-slate-100">{t('landing.features.f3Title')}</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.features.f3Desc')}</p>
            </div>
            ...
            <div className="p-8 rounded-3xl bg-slate-50 dark:bg-slate-800 hover:bg-teal-50/50 dark:hover:bg-teal-950/20 transition-colors border border-slate-100 dark:border-slate-700 hover:border-teal-200 dark:hover:border-teal-900 group text-center">
              ...
              <h3 className="font-bold text-xl mb-3 text-[#0b1c30] dark:text-slate-100">{t('landing.features.f4Title')}</h3>
              <p className="text-slate-600 dark:text-slate-400 text-sm">{t('landing.features.f4Desc')}</p>
            </div>
          </div>
        </section>
            ...
            <div className="bg-white dark:bg-slate-900 p-8 rounded-[40px] shadow-2xl border border-slate-200 dark:border-slate-800 relative overflow-hidden">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between p-5 bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700">
                  ...
                  <button className="bg-teal-600 text-white px-4 py-2 rounded-full text-sm font-bold hover:bg-teal-700 transition">
        ...
        <section id="caregivers" className="py-24 px-6 sm:px-12 md:px-16 bg-white dark:bg-slate-900 scroll-mt-20">
          <div className="max-w-[1440px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-6 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all">
                ...
                <div className="flex justify-between items-center pt-6 border-t border-slate-200 dark:border-slate-700">
                  ...
                  <Link
                    href={card1Href}
                    className="bg-teal-100 dark:bg-teal-950 text-teal-800 dark:text-teal-200 px-4 py-2 rounded-xl text-sm font-bold hover:bg-teal-200 dark:hover:bg-teal-900 transition"
                  >
              ...
              <div className="p-6 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all">
                <div className="flex items-center gap-4 mb-6">
                  <img
                    alt="Michael Torres"
                    className="w-16 h-16 rounded-2xl bg-green-50 object-cover"
              ...
              <div className="p-6 bg-slate-50 dark:bg-slate-800 rounded-3xl border border-slate-200 dark:border-slate-700 hover:shadow-xl transition-all">
                <div className="flex items-center gap-4 mb-6">
                  <img
                    alt="Amina Al-Farsi"
                    className="w-16 h-16 rounded-2xl bg-purple-50 object-cover"
                    src="https://images.unsplash.com/photo-1594824813566-88855ce78961?w=150&auto=format&fit=crop&q=80"
                  />
                  <div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-5 gap-8 items-end justify-items-center">
              ...
              <div className="text-center space-y-4 scale-110">
                <div className="w-32 h-32 sm:w-36 sm:h-36 bg-white dark:bg-slate-800 rounded-full flex items-center justify-center border-4 border-teal-600 dark:border-teal-400 shadow-2xl relative">
                  ...
                  <div className="absolute -top-2 -right-2 bg-teal-600 dark:bg-teal-500 text-white text-[10px] font-bold px-2 py-1 rounded-full">
        ...
        <section className="py-24 px-6 sm:px-12 md:px-16 bg-white dark:bg-slate-900">
          <div className="max-w-[1440px] mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="p-8 rounded-[32px] bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex flex-col justify-between">
              ...
              <div className="p-8 rounded-[32px] bg-teal-50/70 dark:bg-teal-950/40 border border-teal-200 dark:border-teal-900/60 flex flex-col justify-between scale-105 shadow-xl">
        ...
        <section className="py-20 px-6 sm:px-12 md:px-16 my-8">
          <div className="max-w-[1440px] mx-auto">
            <div className="bg-teal-600 dark:bg-slate-900 rounded-[50px] p-12 md:p-20 text-center relative overflow-hidden shadow-2xl dark:border dark:border-slate-800">
              <div className="relative z-10 space-y-6 max-w-3xl mx-auto">
                ...
                <div className="pt-6">
                  <Link
                    href={ctaBtnHref}
                    className="bg-white dark:bg-teal-600 text-teal-700 dark:text-white px-8 py-4 rounded-full font-bold text-lg hover:bg-teal-50 dark:hover:bg-teal-700 transition-all active:scale-95 inline-flex items-center gap-2 shadow-xl"
                  >
