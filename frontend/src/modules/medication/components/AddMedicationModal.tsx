...
export const AddMedicationModal: React.FC<AddMedicationModalProps> = ({
  ...
  return (
    <AppDialog
      ...
      description="Enter medication details with clear placeholders & solid numbers."
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4 pt-2">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div className="w-full space-y-1.5 text-start">
            ...
            <select
              {...register('formType')}
              className="w-full h-11 px-3.5 rounded-xl border border-outline-variant/40 bg-surface-container-lowest dark:bg-surface-container-low text-sm font-semibold text-on-surface focus:ring-2 focus:ring-primary focus:outline-hidden transition-colors cursor-pointer"
            >
          ...
          <div className="flex items-center gap-3 pt-6">
            <input
              ...
              id="isChronic"
              {...register('isChronic')}
              className="w-5 h-5 rounded-lg text-primary border-outline-variant focus:ring-primary cursor-pointer"
            />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          ...
          <AppInput
            ...
            error={errors.refillThreshold?.message}
          />
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
          <div className="w-full space-y-1.5 text-start">
            ...
            <select
              {...register('frequency')}
              className="w-full h-11 px-3.5 rounded-xl border border-outline-variant/40 bg-surface-container-lowest dark:bg-surface-container-low text-xs font-semibold text-on-surface cursor-pointer"
            >
          ...
          <AppInput
            ...
            error={errors.dosesPerDay?.message}
          />
          ...
          <AppInput
            ...
            error={errors.firstDoseTime?.message}
          />
        </div>
