...
export const MedicationFilters = ({ activeFilter, onFilterChange, lowStockCount = 0 }) => {
        ...
        {filters.map((filter) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-1.5 rounded-full text-xs font-bold transition-all duration-200 cursor-pointer flex items-center gap-1.5 border ${
                  isActive
