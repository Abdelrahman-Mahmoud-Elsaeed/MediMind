  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
      ...
      <motion.div whileHover={{ y: -2 }}>
        <Card className="bg-gradient-to-br from-amber-500/10 via-amber-500/5 to-transparent border-amber-200/60 dark:border-amber-900/40">
      ...
      {/* Card 2: Health Tip */}
      <motion.div whileHover={{ y: -2 }}>
        <Card className="bg-gradient-to-br from-emerald-500/10 via-emerald-500/5 to-transparent border-emerald-200/60 dark:border-emerald-900/40">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-2xl bg-[#16B364] text-white flex items-center justify-center shadow-md shadow-emerald-600/20">
              <Lightbulb className="w-5 h-5" />
            </div>
            <div>
              <h4 className="text-xs font-extrabold uppercase tracking-wider text-[#006C4E] dark:text-emerald-300">
      ...
      <motion.div whileHover={{ y: -2 }}>
        <Card className="bg-gradient-to-br from-rose-500/10 via-rose-500/5 to-transparent border-rose-200/60 dark:border-rose-900/40">
          <div className="flex items-center gap-3">
