  ...
  return (<div dir={dir} className="bg-background text-on-surface min-h-screen grid grid-cols-1 lg:grid-cols-2 antialiased overflow-hidden selection:bg-primary-container selection:text-on-primary-container">
    ...
    <div className="flex flex-col min-h-screen px-6 py-6 md:px-12 md:py-8 justify-between overflow-y-auto">
      ...
      <div className="w-full max-w-[480px] mx-auto my-auto">
        ...
        <div className="w-full mb-5 p-3.5 bg-surface-container-high/60 dark:bg-surface-container-high/40 border border-outline-variant/60 rounded-2xl">
          <div className="flex items-center justify-between mb-2.5">
            <span className="text-xs font-bold text-primary flex items-center gap-1.5">
              <span className="material-symbols-outlined text-[16px]">key</span>
              {t("auth.login.demoCredentialsTitle") || "Quick Demo Login"}
            </span>
            <span className="text-[10px] uppercase font-mono tracking-wider px-2 py-0.5 rounded-full bg-primary/10 text-primary font-semibold">
              Pass: Password123!
            </span>
          </div>
          <div className="grid grid-cols-3 gap-2">
            <button
              type="button"
              onClick={() => {
                setLoginInput("patient1@medimind.io");
            ...
            >
              <span className="material-symbols-outlined text-[18px] mb-0.5">person</span>
              <span>Patient</span>
            </button>
            ...
            <button
              type="button"
              onClick={() => {
                setLoginInput("caregiver1@medimind.io");
                setPassword("Password123!");
                setTouchedFields({ loginInput: true, password: true });
              }}
              className="flex flex-col items-center py-2 px-1 text-xs bg-surface hover:bg-primary/10 text-on-surface hover:text-primary rounded-xl border border-outline-variant/40 transition-colors font-medium cursor-pointer"
            >
              <span className="material-symbols-outlined text-[18px] mb-0.5">family_restroom</span>
              <span>Caregiver</span>
            </button>
            ...
            <button
              type="button"
              onClick={() => {
                setLoginInput("pharmacy@medimind.io");
                setPassword("Password123!");
                setTouchedFields({ loginInput: true, password: true });
              }}
              className="flex flex-col items-center py-2 px-1 text-xs bg-surface hover:bg-primary/10 text-on-surface hover:text-primary rounded-xl border border-outline-variant/40 transition-colors font-medium cursor-pointer"
