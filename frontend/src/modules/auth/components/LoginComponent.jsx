      ...
      <main className="relative z-10 w-full max-w-md px-margin-mobile md:px-0">
        <div className="bg-surface-container/50 backdrop-blur-2xl border border-outline-variant/30 rounded-xl p-8 shadow-2xl flex flex-col items-center">
          ...
          <div className="text-center mb-8 w-full">
            ...
            <p className="font-body-md text-body-md text-on-surface-variant">Sign in to continue to your care portal</p>
          </div>
          ...
          <form className="w-full space-y-5" onSubmit={handleLogin}>
            ...
            >
              ...
              {!loading && <span className="material-symbols-outlined text-[20px]" style={{ fontVariationSettings: "'FILL' 0" }}>arrow_forward</span>}
            </button>
          </form>
          ...
          <div className="mt-8 text-center font-body-md text-body-md text-on-surface-variant">
            ...
            <Link className="text-primary hover:text-primary-fixed font-label-md font-semibold ml-1 transition-colors" href="/auth/register">
              Sign Up
            </Link>
          </div>
        </div>
