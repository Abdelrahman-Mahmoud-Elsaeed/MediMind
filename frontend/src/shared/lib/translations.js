  ...
  en: {
    auth: {
      ...
      register: {
        ...
        pharmacistRole: "Pharmacist / Pharmacy",
        pharmacyNameLabel: "Pharmacy Name",
        pharmacyNamePlaceholder: "e.g., MediMind Central Pharmacy",
        licenseNumberLabel: "Pharmacy License Number",
        licenseNumberPlaceholder: "e.g., PH-987654",
        pharmacyPhoneLabel: "Pharmacy Phone (Optional)",
  ...
  ar: {
    auth: {
      ...
      register: {
        ...
        pharmacistRole: "صيدلي / صيدلية",
        pharmacyNameLabel: "اسم الصيدلية",
        pharmacyNamePlaceholder: "مثال: صيدلية ميدي مايند المركزية",
        licenseNumberLabel: "رقم ترخيص مهنة الصيدلة",
        licenseNumberPlaceholder: "مثال: PH-987654",
        pharmacyPhoneLabel: "هاتف الصيدلية (اختياري)",
